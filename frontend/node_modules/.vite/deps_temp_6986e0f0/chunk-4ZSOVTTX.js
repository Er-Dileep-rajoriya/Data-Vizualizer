  ...
  drillDown(drillDownLocator, pivotConfig) {
    ...
    values3.filter(([member]) => member !== "measures").forEach(([member, value]) => {
      ...
      if (granularity !== void 0) {
        ...
        let dateRange = [range3.start, range3.end];
        if (originalTimeDimension == null ? void 0 : originalTimeDimension.dateRange) {
          const [originalStart, originalEnd] = originalTimeDimension.dateRange;
          dateRange = [(0, import_dayjs.default)(originalStart) > range3.start ? (0, import_dayjs.default)(originalStart) : range3.start, (0, import_dayjs.default)(originalEnd) < range3.end ? (0, import_dayjs.default)(originalEnd) : range3.end];
        }
        timeDimensions.push({
...
//# sourceMappingURL=chunk-4ZSOVTTX.js.map
