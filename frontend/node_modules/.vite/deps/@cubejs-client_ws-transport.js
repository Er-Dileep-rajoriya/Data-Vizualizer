...
// node_modules/@cubejs-client/ws-transport/dist/cubejs-client-ws-transport.js
var require_cubejs_client_ws_transport = __commonJS({
  "node_modules/@cubejs-client/ws-transport/dist/cubejs-client-ws-transport.js"(exports, module) {
    ...
    var WebSocket__default = _interopDefaultLegacy(WebSocket2);
    var _excluded = ["baseRequestId"];
    var WebSocketTransportResult = function() {
      function WebSocketTransportResult2(_ref) {
        var status = _ref.status, message = _ref.message;
        _classCallCheck__default["default"](this, WebSocketTransportResult2);
        _defineProperty__default["default"](this, "status", void 0);
        _defineProperty__default["default"](this, "result", void 0);
        this.status = status;
        this.result = message;
      }
      _createClass__default["default"](WebSocketTransportResult2, [{
        key: "json",
        value: function() {
          var _json = _asyncToGenerator__default["default"](_regeneratorRuntime__default["default"].mark(function _callee() {
        ...
        key: "text",
        value: function() {
          var _text = _asyncToGenerator__default["default"](_regeneratorRuntime__default["default"].mark(function _callee2() {
      ...
      return WebSocketTransportResult2;
    }();
    var WebSocketTransport = function() {
      function WebSocketTransport2(_ref2) {
        var authorization = _ref2.authorization, apiUrl = _ref2.apiUrl, heartBeatInterval = _ref2.heartBeatInterval, hearBeatInterval = _ref2.hearBeatInterval;
        _classCallCheck__default["default"](this, WebSocketTransport2);
      ...
      _createClass__default["default"](WebSocketTransport2, [{
        key: "authorization",
        get: function get() {
          return this.token;
        },
        ...
        key: "close",
        value: function() {
          var _close = _asyncToGenerator__default["default"](_regeneratorRuntime__default["default"].mark(function _callee3() {
        ...
        value: function initSocket() {
          ...
          ws.reconcile = function() {
            if ((/* @__PURE__ */ new Date()).getTime() - ws.lastMessageTimestamp.getTime() > 4 * _this.heartBeatInterval * 1e3) {
              ws.close();
            } else {
          ...
          ws.lastMessageTimestamp = /* @__PURE__ */ new Date();
        ...
        value: function sendMessage(message) {
          ...
          setTimeout(_asyncToGenerator__default["default"](_regeneratorRuntime__default["default"].mark(function _callee4() {
        ...
        value: function request(method, _ref4) {
          var baseRequestId = _ref4.baseRequestId, params = _objectWithoutProperties__default["default"](_ref4, _excluded);
          var message = {
          ...
          var runNextMessage = function runNextMessage2() {
            if (nextMessage) {
          ...
          return {
            subscribe: function subscribe(callback) {
              var _this3 = this;
              return _asyncToGenerator__default["default"](_regeneratorRuntime__default["default"].mark(function _callee5() {
                var result;
...
export default require_cubejs_client_ws_transport();
/*! Bundled license information:

@babel/runtime/helpers/regeneratorRuntime.js:
  (*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE *)
*/
//# sourceMappingURL=@cubejs-client_ws-transport.js.map
